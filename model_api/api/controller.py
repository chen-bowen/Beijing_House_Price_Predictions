...
from price_prediction_model.predict import make_prediction
    ...
    if request.method == "POST":
        ...
        if file and allowed_file(file.filename):
            ...
            result = make_single_prediction(
                image_name=filename, image_directory=UPLOAD_FOLDER
            )
        ...
        # Step 5: Return the response as JSON
        return jsonify(
            {"readable_predictions": readable_predictions[0], "version": version}
        )
